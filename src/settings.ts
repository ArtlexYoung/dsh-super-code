...
export const SuperAgentModelSchema: z<{ id: string; strengths: string[]; available: boolean }> = z.object({
  id: z.string(),
  strengths: z.array(z.string()),
  available: z.boolean(),
})

export const SuperAgentSettingsSchema: z<{ modelPools: { high: { id: string; strengths: string[]; available: boolean }[]; normal: { id: string; strengths: string[]; available: boolean }[]; low: { id: string; strengths: string[]; available: boolean }[] }; tokenStats: boolean }> = z.object({
  modelPools: z.object({
